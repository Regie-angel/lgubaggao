...
session_start();
    ...
    $ticket = $_GET['MSWDO_ticket'];

    $database->query("insert into queue(queueNo, Office, type) values ('$ticket', 'Municipal Social Welfare and Development Office', 'NP')");
    ...
    <body>
        ...
        <center>
            ...
            <img src = "../../../../img/<?php $query=$database->query("select * from `lgubaggao` where `contentID` = '1'"); while($data=$query->fetch_array()){ echo $data['logo'];} ?>" height = "25px" width = "25px"/>
                ...
                <h5>Municipal Social Welfare and Development Office</h5>
                <h3>
                    <?php
                        echo "$ticket"; 
                    ?>
