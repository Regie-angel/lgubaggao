...
session_start();
    ...
    $ticket = $_GET['DAO_ticket'];

    $database->query("insert into queue(queueNo, Office, type) values ('$ticket', 'Department of Agriculture Office', 'NP')");
    ...
    <body>
        ...
        <center>
            ...
            <img src = "../../../../img/<?php $query=$database->query("select * from `lgubaggao` where `contentID` = '1'"); while($data=$query->fetch_array()){ echo $data['logo'];} ?>" height = "25px" width = "25px"/>
                ...
                <h5>Department of Agriculture Office</h5>
                <h3>
                    <?php
                        echo "$ticket"; 
                    ?>
