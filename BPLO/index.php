...
<html lang = "en" dir = "ltr">
    ...
    <head>
        ...
        <title> LGU Baggao | Business Permit and Licensing Office</title>
            ...
            <div class="ccontent">
                ...
                <center>
                    ...
                    <ul>
                        ...
                        <a href="Business or Mayor's Permit Issuance (New)/"><li> Business or Mayor's Permit Issuance (New) <i class= 'fa fa-long-arrow-right'></i></li></a>
                        <hr>
                        <a href="Business or Mayor's Permit Issuance (Renewal)/"><li> Business or Mayor's Permit Issuance (Renewal) <i class= 'fa fa-long-arrow-right'></i></li></a>
                        <hr>
                        <a href="Certification for Business Closure or Retirement Issuance/"><li>Certification for Business Closure or Retirement Issuance<i class= 'fa fa-long-arrow-right'></i></li></a>
                    </ul>   
